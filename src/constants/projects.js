...
export const projects = [
  ...
  },
  {
    ...
    category: "Front End",
    shortDescription: "Interface criada para aprender conceitos iniciais do ecossistema do SASS, como a estrutura de diretórios, a organização de arquivos e a compilação para CSS.",
    longDescription: "O projeto foi desenvolvido para entender a estrutura de diretórios do SASS, a organização de arquivos e a compilação para CSS. O foco principal foi aprender a configurar o ambiente de desenvolvimento para compilar arquivos .scss em .css, utilizando variáveis, mixins e aninhamento para criar uma folha de estilos modular e eficiente.",
